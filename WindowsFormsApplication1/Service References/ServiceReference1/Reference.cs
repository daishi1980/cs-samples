...
namespace WindowsFormsApplication1.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/NewProc", ReplyAction="http://tempuri.org/IService1/NewProcResponse")]
        string NewProc(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/NewProc", ReplyAction="http://tempuri.org/IService1/NewProcResponse")]
        System.Threading.Tasks.Task<string> NewProcAsync(string name);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<WindowsFormsApplication1.ServiceReference1.IService1>, WindowsFormsApplication1.ServiceReference1.IService1 {
        ...
        public string NewProc(string name) {
            return base.Channel.NewProc(name);
        }
        
        public System.Threading.Tasks.Task<string> NewProcAsync(string name) {
            return base.Channel.NewProcAsync(name);
        }
    }
}
